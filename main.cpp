...
void main()
{
	...
	Print(Arr, ROWS, COLS);
	cout << "Ñóììà: " << sum(Arr, ROWS, COLS) << endl;
	cout << "Ñðåäíåå àðèôìåòè÷åñêîå: " << avg(Arr, ROWS, COLS) << endl;
	cout << "Ìèíèìàëüíîå çíà÷åíèå: " << minValueIn(Arr, ROWS, COLS) << endl;
	cout << "Ìàêñèìàëüíîå çíà÷åíèå: " << maxValueIn(Arr, ROWS, COLS) << endl;

	sort(Arr, ROWS, COLS);
	cout << "Îòñîðòèðîâàíûé ìàññèâ" << endl;
	Print(Arr, ROWS, COLS);
	...
	cout << "Ñóììà: " << sum(Flot, ROWS, COLS) << endl;
	cout << "Ñðåäíåå àðèôìåòè÷åñêîå: " << avg(Flot, ROWS, COLS) << endl;
	cout << "Ìèíèìàëüíîå çíà÷åíèå: " << minValueIn(Flot, ROWS, COLS) << endl;
	cout << "Ìàêñèìàëüíîå çíà÷åíèå: " << maxValueIn(Flot, ROWS, COLS) << endl;
	sort(Flot, ROWS, COLS);
	cout << "Îòñîðòèðîâàíûé ìàññèâ" << endl;
	Print(Flot, ROWS, COLS);
	...
	cout << "Ñóììà: " << sum(Doub, ROWS, COLS) << endl;
	cout << "Ñðåäíåå àðèôìåòè÷åñêîå: " << avg(Doub, ROWS, COLS) << endl;
	cout << "Ìèíèìàëüíîå çíà÷åíèå: " << minValueIn(Doub, ROWS, COLS) << endl;
	cout << "Ìàêñèìàëüíîå çíà÷åíèå: " << maxValueIn(Doub, ROWS, COLS) << endl;
	sort(Doub, ROWS, COLS);
	cout << "Îòñîðòèðîâàíûé ìàññèâ" << endl;
	Print(Doub, ROWS, COLS);
